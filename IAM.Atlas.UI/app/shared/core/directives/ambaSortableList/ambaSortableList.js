...
// code from http://jsfiddle.net/AMZSK/
// http://stackoverflow.com/questions/15486976/angularui-sortable-does-not-work-for-more-then-one-applications?rq=1

angular.module('AmbaSortableList', [])

    .directive('ambaSortableList', function () {
    return {
        restrict: 'A',
        require: 'ngModel',
