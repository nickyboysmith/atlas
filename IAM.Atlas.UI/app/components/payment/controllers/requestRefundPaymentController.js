(function () {
    ...
    angular
        .module("app")
        .controller("RequestRefundPaymentCtrl", RequestRefundPaymentCtrl);

    RequestRefundPaymentCtrl.$inject = ["$scope", "activeUserProfile", "ModalService", "PaymentService", "RefundService", "DateFactory"];

    function RequestRefundPaymentCtrl($scope, activeUserProfile, ModalService, PaymentService, RefundService, DateFactory) {
        $scope.refund = {};
        $scope.payment = {};
        ...
        $scope.saveRefund = function () {
            if ($scope.validForm()) {
                RefundService.saveRefundRequest(DateFactory.parseDateSlashes($scope.refund.PaymentDate),
                                        $scope.refund.Amount,
                                        ...
                                        $scope.payment.CourseId,
                                        $scope.refund.Notes)
                    .then(
                        function (data) {
                            if (data == true) {
                                $scope.validationMessage = "Refund Request saved.";
