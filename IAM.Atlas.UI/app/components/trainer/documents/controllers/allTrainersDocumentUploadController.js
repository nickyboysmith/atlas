(function () {
    ...
    angular
        .module('app')
        .controller('allTrainersDocumentUploadCtrl', allTrainersDocumentUploadCtrl);

    allTrainersDocumentUploadCtrl.$inject = ["$scope", "$timeout", "TrainerDocumentService", "UserService", "ModalService", "OrganisationService", "activeUserProfile"];

    function allTrainersDocumentUploadCtrl($scope, $timeout, TrainerDocumentService, UserService, ModalService, OrganisationService, activeUserProfile) {
        ...
        $scope.saveFile = function (document) {
            TrainerDocumentService.uploadAllTrainersDocument($scope.covertFormData(document))
            .then(
                    ...
                    $scope.$parent.getDocuments($scope.selectedOrganisationId)
                        .then(
                            function successCallback(response) {
                                ...
                                ModalService.closeCurrentModal("uploadNewAllTrainerDocumentModal");
                            },
