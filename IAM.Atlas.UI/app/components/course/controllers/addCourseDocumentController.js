(function () {
    ...
    angular
        .module('app')
        .controller('addCourseDocumentCtrl', addCourseDocumentCtrl);

    addCourseDocumentCtrl.$inject = ['$scope', '$location', '$window', '$http', 'activeUserProfile', 'CourseService', 'OrganisationSystemConfigurationService']

    function addCourseDocumentCtrl($scope, $location, $window, $http, activeUserProfile, CourseService, OrganisationSystemConfigurationService) {
