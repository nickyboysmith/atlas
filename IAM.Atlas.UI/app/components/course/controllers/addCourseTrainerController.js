(function () {
    ...
    angular
        .module('app')
        .controller("AddCourseTrainerCtrl", AddCourseTrainerCtrl);

    AddCourseTrainerCtrl.$inject = ["$scope", "$filter", "CourseTrainerFactory", "CourseTrainerService", "CourseService", "activeUserProfile"];

    function AddCourseTrainerCtrl($scope, $filter, CourseTrainerFactory, CourseTrainerService, CourseService, activeUserProfile) {
