(function () {
    ...
    angular
        .module("app")
        .controller("AllClientSMSCtrl", AllClientSMSCtrl);

    AllClientSMSCtrl.$inject = ["$scope", "$filter", "SMSService", "ModalService", "activeUserProfile"];

    function AllClientSMSCtrl($scope, $filter, SMSService, ModalService, activeUserProfile) {
        ...
        $scope.GetAllClientsOnCourse = function () {

            SMSService.GetAllClientsOnCourse(activeUserProfile.selectedOrganisation.Id, $scope.$parent.courseId)
                .then(
        ...
        $scope.sendSMS = function () {
            ...
            SMSService.SendAllClientsOnCourse($scope.SMS)
                    .then(
                        function success(response) {
