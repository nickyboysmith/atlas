/*
	SCRIPT: Amend Stored Procedure uspRefreshClientQuickSearchData
	Author: Robert Newnham
	Created: 12/07/2017
*/

DECLARE @ScriptName VARCHAR(100) = 'SP040_28.02_Amend_uspRefreshClientQuickSearchData.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Amend Stored Procedure uspRefreshClientQuickSearchData';
...
*/
CREATE PROCEDURE dbo.uspRefreshClientQuickSearchData (@clientId INT)
AS
	BEGIN
		/*
