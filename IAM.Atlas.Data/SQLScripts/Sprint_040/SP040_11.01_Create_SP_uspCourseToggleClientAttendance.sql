/*
	SCRIPT: Create uspCourseToggleClientAttendance
	Author: Dan Hough
	Created: 03/07/2017
*/

DECLARE @ScriptName VARCHAR(100) = 'SP040_11.01_Create_SP_uspCourseToggleClientAttendance.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Create uspCourseToggleClientAttendance';
