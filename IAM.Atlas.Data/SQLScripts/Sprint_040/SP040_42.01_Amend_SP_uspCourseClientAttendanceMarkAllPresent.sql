/*
	SCRIPT: Amend SP uspCourseClientAttendanceMarkAllPresent
	Author: Robert Newnham
	Created: 18/07/2017
*/

DECLARE @ScriptName VARCHAR(100) = 'SP040_42.01_Amend_SP_uspCourseClientAttendanceMarkAllPresent.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Amend SP uspCourseClientAttendanceMarkAllPresent';
...
GO
	...
	*/
	...
	BEGIN
		...
		LEFT JOIN CourseClientRemoved CCR					ON CCR.CourseId = CC.CourseId
