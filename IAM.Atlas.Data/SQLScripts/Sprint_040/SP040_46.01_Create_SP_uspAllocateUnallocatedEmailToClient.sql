/*
	SCRIPT: Create Stored procedure uspAllocateUnallocatedEmailToClient
	Author: Robert Newnham
	Created: 18/07/2017

*/

DECLARE @ScriptName VARCHAR(100) = 'SP040_46.01_Create_SP_uspAllocateUnallocatedEmailToClient.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Create Stored procedure uspAllocateUnallocatedEmailToClient';
