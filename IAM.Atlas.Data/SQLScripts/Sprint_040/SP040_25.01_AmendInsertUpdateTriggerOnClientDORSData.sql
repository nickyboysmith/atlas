/*
	SCRIPT: Amend Insert Update trigger on ClientDORSData
	Author: Robert Newnham
	Created: 11/07/2017
*/

DECLARE @ScriptName VARCHAR(100) = 'SP040_25.01_AmendInsertUpdateTriggerOnClientDORSData.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Amend Insert Update Trigger on ClientDORSData';
...
GO 
	...
	BEGIN
		DROP TRIGGER TRG_ClientDORSData_InsertUpdate;
	END
