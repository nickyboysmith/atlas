...
DECLARE @ScriptName VARCHAR(100) = 'SP040_16.01_AmendSP_uspGetSelectedColumnsFromViewForKey.sql';
	...
	BEGIN
		...
		*/	
		...
		BEGIN
			...
			IF (@column IN('CourseStartDate', 'CourseStartDate2', 'CourseStartDate3', 'CourseEndDate', 'CourseEndDate2', 'CourseEndDate3'))
			BEGIN
