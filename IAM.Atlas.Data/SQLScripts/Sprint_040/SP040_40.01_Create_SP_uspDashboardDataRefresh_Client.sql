/*
	SCRIPT: Amend Stored procedure uspDashboardDataRefresh
	Author: Robert Newnham
	Created: 17/07/2017

*/

DECLARE @ScriptName VARCHAR(100) = 'SP040_40.01_Create_SP_uspDashboardDataRefresh_Client.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Create Stored procedure uspDashboardDataRefresh_Client';
