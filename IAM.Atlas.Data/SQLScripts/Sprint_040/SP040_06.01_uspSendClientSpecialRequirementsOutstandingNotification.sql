/*
	SCRIPT: Create uspSendClientSpecialRequirementsOutstandingNotification
	Author: Nick Smith
	Created: 30/06/2017
*/

DECLARE @ScriptName VARCHAR(100) = 'SP040_06.01_Create_SP_uspSendClientSpecialRequirementsOutstandingNotification.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Create uspSendClientSpecialRequirementsOutstandingNotification';
