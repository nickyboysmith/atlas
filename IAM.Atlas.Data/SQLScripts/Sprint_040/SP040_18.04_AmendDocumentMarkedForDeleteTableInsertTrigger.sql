/*
	SCRIPT: Insert trigger to DocumentMarkedForDelete table - use dbo.udfGetMessageCategoryId
	Author: Nick Smith
	Created: 05/07/2017
*/
DECLARE @ScriptName VARCHAR(100) = 'SP040_18.04_AmendDocumentMarkedForDeleteTableInsertTrigger.sql';
