...
DECLARE @ScriptName VARCHAR(100) = 'SP037_15.02_Amend_SP_uspDashboardDataRefresh.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Amend Stored procedure uspDashboardDataRefresh';
