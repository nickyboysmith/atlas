/*
	SCRIPT: Amend Stored procedure uspEnsureOrganisationalData
	Author: Robert Newnham
	Created: 02/05/2017

*/

DECLARE @ScriptName VARCHAR(100) = 'SP037_09.01_Amend_SP_uspEnsureOrganisationalData.sql';
...
GO
	...
	*/
	...
	BEGIN
		...
		INSERT INTO dbo.OrganisationSelfConfiguration (OrganisationId, UpdatedByUserId, DateUpdated)
		SELECT DISTINCT
				O.Id								AS OrganisationId
		...
		INSERT INTO dbo.OrganisationSystemConfiguration (OrganisationId, UpdatedByUserId, DateUpdated)
		SELECT DISTINCT 
			O.Id AS OrganisationId
			, dbo.udfGetSystemUserId()			AS UpdatedByUserId
			, GETDATE()							AS DateUpdated
