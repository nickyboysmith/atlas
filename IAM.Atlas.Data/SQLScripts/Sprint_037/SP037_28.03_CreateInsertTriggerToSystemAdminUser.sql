/*
	SCRIPT: Add insert trigger to the SystemAdminUser table
	Author: Robert Newnham
	Created: 15/05/2017
*/

DECLARE @ScriptName VARCHAR(100) = 'SP037_28.03_CreateInsertTriggerToSystemAdminUser.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Add insert trigger to the SystemAdminUser table';
