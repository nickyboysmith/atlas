...
DECLARE @ScriptName VARCHAR(100) = 'SP037_28.04_Amend_InsertTriggerOnOrganisationUserTable.sql';
...
GO
	...
	CREATE TRIGGER RG_OrganisationUser_INSERT ON [OrganisationUser] FOR INSERT
	AS
		...
		BEGIN                 
			EXEC uspLogTriggerRunning 'OrganisationUser', 'RG_OrganisationUser_INSERT', @insertedRows, @deletedRows;
			-------------------------------------------------------------------------------------------
