...
DECLARE @ScriptName VARCHAR(100) = 'SP038_25.02_AmendInsertTriggerOnLetterTemplate.sql';
...
GO
	...
	AS
		...
		BEGIN                 
			...
			--Update the IdKeyName
			UPDATE LT
			SET IdKeyName = LC.IdKeyName
			FROM Inserted I
			INNER JOIN dbo.LetterTemplate LT ON LT.Id = I.Id
			INNER JOIN dbo.LetterCategory LC ON LT.LetterCategoryId = LC.Id
			WHERE LT.IdKeyName IS NULL;
