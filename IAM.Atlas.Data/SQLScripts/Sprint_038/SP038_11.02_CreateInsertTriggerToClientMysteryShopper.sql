/*
 * SCRIPT: Add insert trigger to the ClientMysteryShopper table
 * Author: Robert Newnham
 * Created: 26/05/2017
*/

DECLARE @ScriptName VARCHAR(100) = 'SP038_11.02_CreateInsertTriggerToClientMysteryShopper.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Add insert trigger to the ClientMysteryShopper table';
