/*
	SCRIPT: Alter Stored procedure uspDashboardDataRefresh_Payment
	Author: Nick Smith
	Created: 04/10/2017

*/

DECLARE @ScriptName VARCHAR(100) = 'SP044_16.01_Alter_SP_uspDashboardDataRefresh_Payment.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Alter Stored procedure uspDashboardDataRefresh_Payment';
	...
	BEGIN
		...
		BEGIN TRY 
			DECLARE @TempDashboardMeterData_Payment TABLE (
															...
															, [NumberOfPhonePaymentsTakenToday] [int]
															, [NumberOfPhonePaymentsTakenYesterday] [int]
															, [NumberOfPhonePaymentsTakenThisWeek] [int]
															, [NumberOfPhonePaymentsTakenThisMonth] [int]
															, [NumberOfPhonePaymentsTakenPreviousMonth] [int]
															, [NumberOfPhonePaymentsTakenThisYear] [int]
															, [NumberOfPhonePaymentsTakenPreviousYear] [int]
			...
			INSERT INTO @TempDashboardMeterData_Payment(
															...
															, NumberOfPhonePaymentsTakenToday
															, NumberOfPhonePaymentsTakenYesterday
															, NumberOfPhonePaymentsTakenThisWeek
															, NumberOfPhonePaymentsTakenThisMonth
															, NumberOfPhonePaymentsTakenPreviousMonth
															, NumberOfPhonePaymentsTakenThisYear
															, NumberOfPhonePaymentsTakenPreviousYear
			...
			SELECT 
				...
				, SUM(CASE WHEN P.CreatedToday = 'True'
							AND P.PaidByClientOnline = 'False' THEN 1 ELSE 0 END)				AS NumberOfPhonePaymentsTakenToday
				, SUM(CASE WHEN P.CreatedYesterday = 'True'
							AND P.PaidByClientOnline = 'False' THEN 1 ELSE 0 END)				AS NumberOfPhonePaymentsTakenYesterday
				, SUM(CASE WHEN P.CreatedThisWeek = 'True'
							AND P.PaidByClientOnline = 'False' THEN 1 ELSE 0 END)				AS NumberOfPhonePaymentsTakenThisWeek
				, SUM(CASE WHEN P.CreatedThisMonth = 'True'
							AND P.PaidByClientOnline = 'False' THEN 1 ELSE 0 END)				AS NumberOfPhonePaymentsTakenThisMonth
				, SUM(CASE WHEN P.CreatedPreviousMonth = 'True'
							AND P.PaidByClientOnline = 'False' THEN 1 ELSE 0 END)				AS NumberOfPhonePaymentsTakenPreviousMonth
				, SUM(CASE WHEN P.CreatedThisYear = 'True'
							AND P.PaidByClientOnline = 'False' THEN 1 ELSE 0 END)				AS NumberOfPhonePaymentsTakenThisYear
				, SUM(CASE WHEN P.CreatedPreviousYear = 'True'
							AND P.PaidByClientOnline = 'False' THEN 1 ELSE 0 END)				AS NumberOfPhonePaymentsTakenPreviousYear
			...
			SELECT 
				...
				, D.NumberOfPhonePaymentsTakenToday
				, D.NumberOfPhonePaymentsTakenYesterday
				, D.NumberOfPhonePaymentsTakenThisWeek
				, D.NumberOfPhonePaymentsTakenThisMonth
				, D.NumberOfPhonePaymentsTakenPreviousMonth
				, D.NumberOfPhonePaymentsTakenThisYear
				, D.NumberOfPhonePaymentsTakenPreviousYear
			...
			SET
				...
				, T.NumberOfPhonePaymentsTakenToday = D.NumberOfPhonePaymentsTakenToday
				, T.NumberOfPhonePaymentsTakenYesterday = D.NumberOfPhonePaymentsTakenYesterday
				, T.NumberOfPhonePaymentsTakenThisWeek = D.NumberOfPhonePaymentsTakenThisWeek
				, T.NumberOfPhonePaymentsTakenThisMonth = D.NumberOfPhonePaymentsTakenThisMonth
				, T.NumberOfPhonePaymentsTakenPreviousMonth = D.NumberOfPhonePaymentsTakenPreviousMonth
				, T.NumberOfPhonePaymentsTakenThisYear = D.NumberOfPhonePaymentsTakenThisYear
				, T.NumberOfPhonePaymentsTakenPreviousYear = D.NumberOfPhonePaymentsTakenPreviousYear
