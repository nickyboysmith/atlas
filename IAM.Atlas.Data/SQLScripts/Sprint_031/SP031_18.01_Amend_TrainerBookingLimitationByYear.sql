/*
	SCRIPT:  Amend TrainerBookingLimitationByYear Table 
	Author: Dan Hough
	Created: 30/12/2016
*/

DECLARE @ScriptName VARCHAR(100) = 'SP031_18.01_Amend_TrainerBookingLimitationByYear.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Amend TrainerBookingLimitationByYear Table';
