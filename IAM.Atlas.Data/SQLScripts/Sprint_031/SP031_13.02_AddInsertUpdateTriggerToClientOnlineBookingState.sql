/*
	SCRIPT: Add Insert and Update Trigger To ClientOnlineBookingState
	Author: Robert Newnham
	Created: 29/12/2016
*/

DECLARE @ScriptName VARCHAR(100) = 'SP031_13.02_AddInsertUpdateTriggerToClientOnlineBookingState.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Add Insert and Update Trigger To ClientOnlineBookingState';
