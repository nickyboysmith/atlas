/*
	SCRIPT: Change insert trigger on CourseGroupEmailRequest to Insert Update
	Author: Robert Newnham
	Created: 30/01/2017
*/

DECLARE @ScriptName VARCHAR(100) = 'SP030_29.01_ChangeInsertTriggerOnCourseGroupEmailRequestToInsertUpdate.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Change insert trigger on CourseGroupEmailRequest to Insert Update';
...
GO
	...
	/*******************************************************************************************************************/
	CREATE TRIGGER TRG_CourseGroupEmailRequest_InsertUpdate ON dbo.CourseGroupEmailRequest AFTER INSERT, UPDATE
	AS
	BEGIN
