/*
	SCRIPT: Amend the SendEmail Stored Procedure To Allow for Email attachments
	Author: Robert Newnham
	Created: 29/01/2017
*/

DECLARE @ScriptName VARCHAR(100) = 'SP032_27.01_Amend_uspSendEmail.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Amend the SendEmail Stored Procedure To Allow for Email attachments';
	...
	BEGIN
		...
		BEGIN TRY			
			...
			BEGIN
				...
				LEFT JOIN dbo.FileStoragePath FSP			ON FSP.Id = D.Id
