/*
	SCRIPT: Amend stored procedure uspLinkTrainersToSameDORSSchemeAcrossCourseTypes
	Author: Dan Hough
	Created: 16/01/2016

*/

DECLARE @ScriptName VARCHAR(100) = 'SP032_10.01_Create_uspLinkTrainersToSameDORSSchemeAcrossCourseTypes.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Amend stored procedure uspLinkTrainersToSameDORSSchemeAcrossCourseTypes';
...
BEGIN
	...
	INNER JOIN CourseType CT ON CT.Id = DSCT2.CourseTypeId
	...
	INNER JOIN TrainerOrganisation TRO ON tro.OrganisationId = ct.OrganisationId
