...
DECLARE @ScriptName VARCHAR(100) = 'SP041_09.01_Create_uspCreateEmailCourseReminders_SendEmailRemindersToClients.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Amend uspCreateEmailCourseReminders -- add asap flag to emails';
