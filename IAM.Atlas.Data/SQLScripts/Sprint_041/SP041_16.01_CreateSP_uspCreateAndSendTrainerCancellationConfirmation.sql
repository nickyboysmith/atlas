/*
	SCRIPT: Create Stored procedure uspCreateAndSendTrainerCancellationConfirmation
	Author: Dan Hough
	Created: 27/07/2017

*/

DECLARE @ScriptName VARCHAR(100) = 'SP041_16.01_CreateSP_uspCreateAndSendTrainerCancellationConfirmation';
DECLARE @ScriptComments VARCHAR(800) = 'Create Stored procedure uspCreateAndSendTrainerCancellationConfirmation';
...
GO
	...
	*/
	...
	CREATE PROCEDURE [dbo].[uspCreateAndSendTrainerCancellationConfirmation](@courseTrainerId INT)
	AS
	BEGIN
