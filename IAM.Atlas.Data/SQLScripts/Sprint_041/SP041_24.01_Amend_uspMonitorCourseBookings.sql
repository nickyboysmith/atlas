/*
	SCRIPT: Amend stored procedure uspMonitorCourseBookings add Course Reference and CourseId to email subject
	Author: Nick Smith
	Created: 01/08/2016
*/

DECLARE @ScriptName VARCHAR(100) = 'SP041_24.01_Amend_uspMonitorCourseBookings.sql';
	...
	BEGIN
		...
		DECLARE bookingsCursor CURSOR FOR 
			SELECT DISTINCT
				...
				, 'Course Overbooked, Reference ' 
					+ ISNULL(C.CourseReference, 'N/A') 
					+ '(' + CONVERT(varchar(10), C.CourseId) + ')'	AS EmailTitle
