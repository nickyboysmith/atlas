/*
	SCRIPT: Create Stored procedure uspCheckForDuplicateClientsNotifySystemAdmins
	Author: Robert Newnham
	Created: 21/07/2017

*/

DECLARE @ScriptName VARCHAR(100) = 'SP041_02.05_Create_SP_uspCheckForDuplicateClientsNotifySystemAdmins.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Create Stored procedure uspCheckForDuplicateClientsNotifySystemAdmins';
		...
		BEGIN TRY
			IF EXISTS(SELECT * 
				...
				DECLARE duplicateClients CURSOR FOR  
					SELECT TOP 10 CLL2.ClientId, CLL2.[LicenceNumber]
					FROM (
