...
/****** Object:  StoredProcedure [dbo].[uspCreateMigrationExternalTables]    Script Date: 13/10/2016 10:48:09 ******/
...
*/
CREATE PROCEDURE [dbo].[uspCreateMigrationExternalTables]
AS
BEGIN
	...
	CREATE EXTERNAL TABLE [migration].[tbl_NetcallLog](
		[NetcallLogID] [int] NOT NULL,
	...
	CREATE EXTERNAL TABLE [migration].[tbl_Organisation_RegCrseType](
		[orc_id] [int] NOT NULL,
		[orc_rct_id] [int] NULL,
		[orc_org_id] [int] NULL,
		[orc_isReferrer] [bit] NOT NULL,
		[orc_isServiceProvider] [bit] NOT NULL)
	 WITH ( DATA_SOURCE = IAM_Elastic_Old_Atlas ) ;
