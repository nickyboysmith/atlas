/*
	SCRIPT: Amend uspSendRefundRequestNotification
	Author: Dan Hough
	Created: 17/03/2017
*/

DECLARE @ScriptName VARCHAR(100) = 'SP035_09.01_Amend_SP_uspSendRefundRequestNotification.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Amend uspSendRefundRequestNotification';
	...
	*/
	...
	BEGIN
		...
		INNER JOIN dbo.OrganisationEmailTemplateMessage OETM ON VWRR.RefundRequestOrganisationId = OETM.OrganisationId
																AND OETM.Code = @payRefRequestUser
