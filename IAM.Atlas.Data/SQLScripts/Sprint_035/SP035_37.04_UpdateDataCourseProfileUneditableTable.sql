/*
	SCRIPT: Update the data in CourseProfileUneditable Table 
	Author: Robert Newnham
	Created: 02/04/2017
*/

DECLARE @ScriptName VARCHAR(100) = 'SP035_37.04_UpdateDataCourseProfileUneditableTable.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Update the data in CourseProfileUneditable Table';
IF (dbo.udfAllScriptsCompletedExcept(@ScriptName) = 'True')
	BEGIN
		...
		WHERE CPU.Id IS NULL --Only Insert if not already there
