/*
	SCRIPT: Create an Update Trigger on the Table DORSConnection
	Author: Nick Smith
	Created: 02/04/2017
*/

DECLARE @ScriptName VARCHAR(100) = 'SP035_32.01_CreateUpdateTriggerOnDORSConnection.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Create Update trigger on DORSConnection';
...
BEGIN
	...
	BEGIN                 
		...
		WHERE d.DateLastConnectionFailure != i.DateLastConnectionFailure
