/*
	SCRIPT: Create Stored procedure uspMarkForDeletionRecentlyCreatedDuplicates
	Author: Robert Newnham
	Created: 25/08/2017

*/

DECLARE @ScriptName VARCHAR(100) = 'SP042_18.01_Create_SP_uspMarkForDeletionRecentlyCreatedDuplicates.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Create Stored procedure uspMarkForDeletionRecentlyCreatedDuplicates';
