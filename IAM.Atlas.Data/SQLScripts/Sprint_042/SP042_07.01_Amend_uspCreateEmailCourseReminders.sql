...
DECLARE @ScriptName VARCHAR(100) = 'SP042_07.01_Amend_uspCreateEmailCourseReminders.sql';
	...
	BEGIN
		...
		*/
		...
		FROM [dbo].[vwCourseClientWithEmailRemindersDue] v
			...
			INNER JOIN vwCourseDetail CD ON v.CourseId = CD.CourseId
			INNER JOIN VenueAddress VA ON CD.VenueId = VA.VenueId
