/*
	SCRIPT: Amend insert trigger on the CourseClientTransferRequest table - Get correct Organisation from OrganisationDisplay
	Author: Nick Smith
	Created: 22/06/2017
*/

DECLARE @ScriptName VARCHAR(100) = 'SP039_16.01_AmendInsertTriggerOnCourseClientTransferRequest.sql';
