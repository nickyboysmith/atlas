/*
	SCRIPT: Create Update trigger on the LetterTemplateDocument table
	Author: Robert Newnham
	Created: 14/06/2017
*/

DECLARE @ScriptName VARCHAR(100) = 'SP039_11.03_CreateUpdateTriggerOnLetterTemplateDocument.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Create Update trigger on the LetterTemplateDocument table';
...
CREATE TRIGGER [dbo].[TRG_LetterTemplateDocument_Update] ON [dbo].[LetterTemplateDocument] AFTER UPDATE
	...
	BEGIN
		...
		BEGIN --START PROCESS
			...
			INNER JOIN doc.[DocumentOwner] DO			ON DO.DocumentId = D.Id
