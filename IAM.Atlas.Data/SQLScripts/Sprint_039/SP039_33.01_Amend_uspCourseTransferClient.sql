...
DECLARE @ScriptName VARCHAR(100) = 'SP039_33.01_Amend_uspCourseTransferClient.sql';
...
BEGIN
	...
	BEGIN
		...
		BEGIN
			...
			IF (NOT EXISTS(SELECT * FROM dbo.CourseClient WHERE CourseId = @toCourseId AND ClientId = @toClientId))
			BEGIN
