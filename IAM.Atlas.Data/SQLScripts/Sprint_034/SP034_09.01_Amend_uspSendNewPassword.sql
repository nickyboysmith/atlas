/*
	...
	Created: 06/03/2017
*/
DECLARE @ScriptName VARCHAR(100) = 'SP034_09.01_Amend_uspSendNewPassword.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Amend SP uspSendNewPassword. Now finds organisation if a Trainer.';
