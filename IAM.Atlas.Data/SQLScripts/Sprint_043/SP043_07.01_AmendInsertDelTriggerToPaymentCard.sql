...
DECLARE @ScriptName VARCHAR(100) = 'SP043_07.01_AmendInsertDelTriggerToPaymentCard.sql';
...
GO
	...
	BEGIN
		...
		BEGIN                 
			EXEC uspLogTriggerRunning 'PaymentCard', 'TRG_PaymentCard_InsertUpdateDelete', @insertedRows, @deletedRows;
			-------------------------------------------------------------------------------------------
