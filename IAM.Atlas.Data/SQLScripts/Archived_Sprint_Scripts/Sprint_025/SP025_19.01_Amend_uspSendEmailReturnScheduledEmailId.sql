/*
	SCRIPT: Amend the SendEmail Stored Procedure To Return ScheduledEmailId
	Author: Nick Smith
	Created: 06/09/2016
*/

DECLARE @ScriptName VARCHAR(100) = 'SP025_19.01_Amend_uspSendEmailReturnScheduledEmailId.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Amend the SendEmail Stored Procedure To Return ScheduledEmailId.';
