/*
	SCRIPT: Amend SP uspCheckUser. Ensure User has Login Id
	Author: Robert Newnham
	Created: 09/09/2016
*/

DECLARE @ScriptName VARCHAR(100) = 'SP026_14.03_AmendSP_uspCheckUser.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Amend SP uspCheckUser. Ensure User has Login Id';
