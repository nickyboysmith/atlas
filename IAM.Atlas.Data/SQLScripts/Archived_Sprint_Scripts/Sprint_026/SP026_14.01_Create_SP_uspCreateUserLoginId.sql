/*
	SCRIPT: Create a stored procedure to create a User Login Id
	Author: Robert Newnham
	Created: 09/09/2016
*/

DECLARE @ScriptName VARCHAR(100) = 'SP026_14.01_Create_SP_uspCreateUserLoginId.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Create a stored procedure to create a User Login Id';
	...
	AS
		...
		BEGIN
			...
			BEGIN
				...
				SET [LoginId] = @LoginId
				WHERE [Id] = @UserId
				AND LEN(ISNULL([LoginId], '')) <= 0; --ie not already there;
