/*
	SCRIPT: Fix bug in uspSendNewPassword
	Author: Dan Murray
	Created: 23/05/2016
*/
DECLARE @ScriptName VARCHAR(100) = 'SP020_43.01_Fix_uspSendNewPassword.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Fix bug in uspSendNewPassword';
