/*
	...
	Author: Paul Tuck, Amended by Robert Newnham
	Created: 04/02/2016, Amended: 10/05/2016
*/

DECLARE @ScriptName VARCHAR(100) = 'SP020_19.02_Amend_uspCheckDORSConnectionExpiry.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Amend the stored procedure to send emails and messages when a user''s DORS login is about to expire.';
