...
/*
	...
	Created: 29/01/2016
	Amended: Robert Newnham, 23/05/2016
*/

DECLARE @ScriptName VARCHAR(100) = 'SP020_42.01_Amend_uspDropMigrationExternalTables.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Amend the stored procedure to Drop the Migration External Tables from Old Atlas. Ensure the "migration" Schema exists';
