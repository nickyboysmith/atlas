/*
	SCRIPT: Amend the SendEmail Stored Procedure
	Author: Robert Newnham
	Created: 28/01/2016
*/

DECLARE @ScriptName VARCHAR(100) = 'SP020_19.01_Amend_uspSendEmail.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Amend the SendEmail Stored Procedure.';
