/*
	SCRIPT: Amend stored procedure to send new password
	Author: Dan Hough
	Created: 12/05/2016
*/
DECLARE @ScriptName VARCHAR(100) = 'SP020_29.01_Amend_spSendNewPassword.sql';
...
CREATE PROCEDURE dbo.spSendNewPassword @LoginId VARCHAR(320)
AS
BEGIN
	...
	BEGIN
		...
		EXEC dbo.spSetPassword @UserId = @User_Id
