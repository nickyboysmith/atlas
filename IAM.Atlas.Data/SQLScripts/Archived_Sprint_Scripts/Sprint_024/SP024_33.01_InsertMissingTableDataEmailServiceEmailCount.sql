/*
 * SCRIPT: Insert Missing Table Data EmailServiceEmailCount
 * Author: Robert Newnham
 * Created: 17/08/2016
 */
 
DECLARE @ScriptName VARCHAR(100) = 'SP024_33.01_InsertMissingTableDataEmailServiceEmailCount.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Insert Missing Table Data EmailServiceEmailCount';
