/*
	SCRIPT: Amend Client Quick Search Data Stored Procedure
	Author: Paul Tuck
	Created: 17/06/2016
*/

DECLARE @ScriptName VARCHAR(100) = 'SP022_01.01_Amend_usp_RefreshAllClientQuickSearchData.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Amend the stored procedure to create client quick-search data';
