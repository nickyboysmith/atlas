...
DECLARE @ScriptName VARCHAR(100) = 'SP022_22.01_Create_uspMonitorCourseBookings.sql';
	...
	*/
	...
	BEGIN
		...
		DECLARE bookingsCursor CURSOR FOR  
			...
			'Course Type: ' + CT.Title  + CHAR(13) + CHAR(10) +
			'Course Reference: ' + C.Reference  + CHAR(13) + CHAR(10) +
			'Course Dates: ' + 	dbo.ufn_GetCourseDatesAsString(C.Id) + CHAR(13) + CHAR(10) +
			'Course Venue: ' + V.Title + CHAR(13) + CHAR(10) +
			...
			dbo.ufn_GetCourseClientsAsString(C.Id)
									AS EmailContent,
