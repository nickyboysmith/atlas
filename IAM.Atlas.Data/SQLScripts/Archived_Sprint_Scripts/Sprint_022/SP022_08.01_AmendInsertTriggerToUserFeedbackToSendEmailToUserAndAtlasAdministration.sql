...
DECLARE @ScriptName VARCHAR(100) = 'SP022_08.01_AmendInsertTriggerToUserFeedbackToSendEmailToUserAndAtlasAdministration.sql';
...
AS		
		...
		SET @emailContent = @emailContent + @NewLineChar + 'Feedback Created ' + @creationDate; 
