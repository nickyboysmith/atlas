/*
	SCRIPT: Amend insert trigger to the Document table. 
	Author: Nick Smith
	Created: 24/06/2016
*/

DECLARE @ScriptName VARCHAR(100) = 'SP022_07.01_AmendInsertTriggerToDocumentToUpdateColumnDocumentTypeIfOriginalFileNameEmpty.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Amend insert trigger to the Document table. If DocumentType empty, check OriginalFileName and extract extension and update DocumentType';
