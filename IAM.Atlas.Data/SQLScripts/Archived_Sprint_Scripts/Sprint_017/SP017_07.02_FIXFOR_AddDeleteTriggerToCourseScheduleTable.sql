...
/*
	SCRIPT:  FIX FOR Add delete trigger to the CourseSchedule table
	Author: Dan Murray, fixed by Robert Newnham
	Created: 11/03/2016
*/

DECLARE @ScriptName VARCHAR(100) = 'SP017_07.02_FIXFOR_AddDeleteTriggerToCourseScheduleTable.sql';
