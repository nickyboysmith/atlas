...
/*
	SCRIPT: FIX FOR Add insert trigger to the CourseSchedule table
	Author: Dan Murray, fixed by Robert Newnham
	Created: 11/03/2016
*/

DECLARE @ScriptName VARCHAR(100) = 'SP017_07.06_FIXFOR_AddInsertTriggerToCourseScheduleTable.sql';
