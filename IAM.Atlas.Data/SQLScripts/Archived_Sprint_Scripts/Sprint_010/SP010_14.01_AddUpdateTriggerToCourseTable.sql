...
/*
	SCRIPT: Add update trigger to the Course table
	Author: Dan Murray
	Created: 09/10/2015
*/

DECLARE @ScriptName VARCHAR(100) = 'SP010_14.01_AddUpdateTriggerToCourseTable.sql';
...
IF OBJECT_ID('dbo.[TRG_Course_UPDATE]', 'TR') IS NOT NULL
		...
		END
GO
		CREATE TRIGGER TRG_Course_UPDATE ON Course FOR UPDATE
AS
