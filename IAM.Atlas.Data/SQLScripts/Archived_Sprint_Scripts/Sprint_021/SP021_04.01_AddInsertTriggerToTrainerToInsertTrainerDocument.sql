...
DECLARE @ScriptName VARCHAR(100) = 'SP021_04.01_AddInsertTriggerToTrainerToInsertTrainerDocument.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Add insert trigger to the Trainer table. 
...
IF OBJECT_ID('dbo.[TRG_TrainerToInsertTrainerDocument_INSERT]', 'TR') IS NOT NULL
		...
		END
GO
		CREATE TRIGGER TRG_TrainerToInsertTrainerDocument_INSERT ON Trainer FOR INSERT
AS
