/*
	SCRIPT: Create Cancelled Course Table
	Author: Nick Smith
	Created: 07/06/2016
*/

DECLARE @ScriptName VARCHAR(100) = 'SP021_31.01_CreateCancelledCourseTable.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Create CancelledCourse Table';
