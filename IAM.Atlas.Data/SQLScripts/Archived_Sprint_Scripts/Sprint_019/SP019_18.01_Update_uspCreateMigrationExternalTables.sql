...
DECLARE @ScriptName VARCHAR(100) = 'SP019_18.01_Update_uspCreateMigrationExternalTables.sql';
...
BEGIN
	...
	IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'tbl_LU_PaymentMethod')
	BEGIN
