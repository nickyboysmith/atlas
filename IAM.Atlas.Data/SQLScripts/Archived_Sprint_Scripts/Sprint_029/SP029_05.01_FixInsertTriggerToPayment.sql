/*
	SCRIPT: Fix Insert Trigger on the Payment table
	Author: Robert Newnham
	Created: 14/11/2016
*/

DECLARE @ScriptName VARCHAR(100) = 'SP029_05.01_FixInsertTriggerToPayment.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Fix Insert Trigger on the Payment table';
