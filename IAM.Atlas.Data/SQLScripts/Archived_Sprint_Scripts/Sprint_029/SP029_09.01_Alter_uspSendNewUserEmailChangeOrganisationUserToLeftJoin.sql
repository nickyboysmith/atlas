/*
 * SCRIPT: Alter uspSendNewUserEmail Change OrganisationUser To Left Join
 * Author: Nick Smith
 * Created: 16/11/2016
 */

DECLARE @ScriptName VARCHAR(100) = 'SP029_09.01_Alter_uspSendNewUserEmailChangeOrganisationUserToLeftJoin.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Alter uspSendNewUserEmail Change OrganisationUser To Left Join';
