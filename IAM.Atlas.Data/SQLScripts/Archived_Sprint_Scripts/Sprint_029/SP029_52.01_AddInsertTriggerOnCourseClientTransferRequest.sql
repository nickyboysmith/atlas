...
DECLARE @ScriptName VARCHAR(100) = 'SP029_52.01_AddInsertTriggerOnCourseClientTransferRequest.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Add insert trigger on the CourseClientTransferRequest table';
...
BEGIN
	...
	FROM Inserted i
	INNER JOIN dbo.CourseClient ccFrom ON i.TransferFromCourseId = ccFrom.CourseId
	...
	INNER JOIN dbo.CourseClient ccTo ON i.TransferToCourseId = ccTo.CourseId
