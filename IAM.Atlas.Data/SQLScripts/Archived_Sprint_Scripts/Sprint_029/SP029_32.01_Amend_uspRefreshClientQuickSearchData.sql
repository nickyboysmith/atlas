/*
	SCRIPT: Amend Stored Procedure to replace SPs usp_RefreshSingleClientQuickSearchData and usp_RefreshAllClientQuickSearchData
	Author: Robert Newnham
	Created: 24/11/2016
*/

DECLARE @ScriptName VARCHAR(100) = 'SP029_32.01_Amend_uspRefreshClientQuickSearchData.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Amend Stored Procedure to replace SPs usp_RefreshSingleClientQuickSearchData and usp_RefreshAllClientQuickSearchData';
