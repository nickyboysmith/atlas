/*
	SCRIPT: Amend trigger on the Client and ClientOrganisation table: populate quick search table entries
	Author: Robert Newnham
	Created: 24/11/2016
*/

DECLARE @ScriptName VARCHAR(100) = 'SP029_30.01_AmendTriggersForClientQuickSearch.sql';
