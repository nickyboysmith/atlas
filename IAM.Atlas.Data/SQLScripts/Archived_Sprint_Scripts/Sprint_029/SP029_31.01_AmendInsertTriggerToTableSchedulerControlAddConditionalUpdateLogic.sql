...
DECLARE @ScriptName VARCHAR(100) = 'SP029_31.01_AmendInsertTriggerToTableSchedulerControlAddConditionalUpdateLogic.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Amend Insert trigger to the SchedulerControl table add conditional update logic';
