/*
	SCRIPT: Create SP to Insert CourseDORSClient Data If Missing.
	Author: Robert Newnham
	Created: 15/10/2016
*/

DECLARE @ScriptName VARCHAR(100) = 'SP027_34.06_CreateSP_uspInsertCourseDORSClientDataIfMissing.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Create SP to Insert CourseDORSClient Data If Missing.';
	...
	*/
	...
	BEGIN
			...
			SELECT 
				...
				, NULL			AS DORSAttendanceStateIdentifier
