/*
	SCRIPT: Re-Run Stored procedure after the creation of the PostCodeInformation Table
	Author: Dan Hough
	Created: 21/10/2016

*/

DECLARE @ScriptName VARCHAR(100) = 'SP028_17.01_ReRun_SP_uspUpdateTrainerVenueDistance.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Re-Run Stored procedure after the creation of the PostCodeInformation Table';
