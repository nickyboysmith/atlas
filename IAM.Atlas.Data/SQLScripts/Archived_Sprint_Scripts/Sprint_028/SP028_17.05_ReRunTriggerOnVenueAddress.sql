/*
	SCRIPT: Re-Run TRG_VenueAddressToUpdateTrainerVenueDistance_Update on the VenueAddress table after PostCodeInformation table is created
	Author: Dan Hough
	Created: 24/10/2016
*/

DECLARE @ScriptName VARCHAR(100) = 'SP028_17.05_ReRunTriggerOnVenueAddress.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Re-Run TRG_VenueAddressToUpdateTrainerVenueDistance_Update on the VenueAddress table after PostCodeInformation table is created';
