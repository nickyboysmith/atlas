/*
	SCRIPT: Re-Run trigger TRG_TrainerToUpdateDistance_Update after PostCodeInformation table is created
	Author: Dan Hough
	Created: 24/10/2016
*/

DECLARE @ScriptName VARCHAR(100) = 'SP028_17.02_ReRunUpdateTriggerOnTrainer.sql';
DECLARE @ScriptComments VARCHAR(800) = 'Re-Run trigger TRG_TrainerToUpdateDistance_Update after PostCodeInformation table is created';
...
GO
		CREATE TRIGGER 
		TRG_TrainerToUpdateDistance_Update ON dbo.Trainer AFTER UPDATE
AS
