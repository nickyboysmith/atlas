...
DECLARE @Rep1Name AS VARCHAR(100) = 'Course Trainers'
...
DECLARE @Par4ColumnName AS VARCHAR(100) = 'CourseTypeId'
	, @Par4Title AS VARCHAR(100) = 'Course Type'
	, @Par4Type AS VARCHAR(100) = 'CourseType'
	, @Par4TypeId AS INT = (SELECT TOP 1 Id FROM dbo.ReportDataType WHERE DataTypeName = 'CourseType');
	;
